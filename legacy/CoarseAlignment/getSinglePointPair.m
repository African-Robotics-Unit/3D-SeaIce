function [point1, point2] = getSinglePointPair(fig1, fig2)
...
%dcm_obj1.DisplayStyle = 'window';
%dcm_obj2.DisplayStyle = 'window';
% Set update function
...
%     disp('Select matching points in figure1 and figure2 then press enter')
    ...
    if ((isfield(info_struct1, 'Position')) && (isfield(info_struct2, 'Position')))
        ...
        point1=info_struct1.Position;
        point2=info_struct2.Position;
%         ax1=fig1.gca;
%         hold(ax1, "on");
%         scatter3(0,0,0,22,"red","filled");
%         hold(ax1, "off");
