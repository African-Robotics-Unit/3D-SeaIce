...
m.drawparallels(parallels,labels=[False,True,False,False],fontsize=5,color='#808080') # labels = [left,right,top,bottom]
meridians = np.arange(0.,360.,0.2)
m.drawmeridians(meridians,labels=[False,False,False,True],fontsize=5,color='#808080')
...
leg =ax.legend(loc='upper center',bbox_to_anchor=(0.5,-0.2),frameon=True, ncol=5,prop={'size':10})
